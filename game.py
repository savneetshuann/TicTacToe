...
def with_player(game_board,user_name1):
    global username1
...
def open_single(game_board):
    ...
    submit_btn = Button(game_board, text="Play", command=wpc, activeforeground='white',
...
def open_multiple():
    ...
    submit_btn = Button(top, text="Play", command=lambda: wpl(user_name1), activeforeground='white',
                        activebackground="grey", bg="blue", fg="white", font='Gabriola')
